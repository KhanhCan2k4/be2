...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('comments')->insert(
            [
                'id' => 1,
                'content' => 'iPhone 14 Pro. Bắt trọn chi tiết ấn tượng với Camera Chính 48MP. Trải nghiệm iPhone theo cách hoàn toàn mới với Dynamic Island và màn hình Luôn Bật. Phát Hiện Va Chạm,1 một tính năng an toàn mới, thay bạn gọi trợ giúp khi cần kíp.',
                'product_id' => '1',
                'user_id' => '1',
                'rate' => 3,
            ],
        ...
        DB::unprepared(
            file_get_contents('K:\classfolder\hk4\be2\week2\be2-1.sql')
        );
